...
- (void)setupLoadingView
{
    ...
    [_dimIamge sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://img.meelive.cn/%@", _imageUrl]]
                 placeholderImage:[UIImage imageNamed:@"YXLiveImageDefault"]];
...
- (void)setupBtn {
    ...
    backBtn.frame = CGRectMake(10, 64 / 2 - 8, 36, 34);
    [backBtn setImage:[UIImage imageNamed:@"YXCommonBack"] forState:UIControlStateNormal];
    ...
    playBtn.frame = CGRectMake(KScreanWidth - 33 - 10, 64 / 2 - 8, 33, 33);
    
    if (self.number == 0) {
        [playBtn setImage:[UIImage imageNamed:@"YXReplay_Pause"] forState:(UIControlStateNormal)];
        [playBtn setImage:[UIImage imageNamed:@"YXReplay_Play"] forState:(UIControlStateSelected)];
    }else{
        [playBtn setImage:[UIImage imageNamed:@"YXReplay_Play"] forState:(UIControlStateNormal)];
        [playBtn setImage:[UIImage imageNamed:@"YXReplay_Pause"] forState:(UIControlStateSelected)];
    }
    ...
    heartBtn.frame = CGRectMake(36, KScreanHeight - 36 - 10, 36, 36);
    [heartBtn setImage:[UIImage imageNamed:@"YXLiveHotLevel"] forState:UIControlStateNormal];
    ...
    giftBtn.frame = CGRectMake(KScreanWidth - 50, KScreanHeight - 36 - 10, 36, 36);
    [giftBtn setImage:[UIImage imageNamed:@"YXLiveGift"] forState:UIControlStateNormal];
...
- (void)showMyPorsche918 {
    ...
    [UIView animateWithDuration:durTime animations:^{
        ...
        porsche918.frame = CGRectMake(KScreanWidth * 0.5 - 100, KScreanHeight * 0.5 - 100 * 0.5, 240, 120);
    }];
    ...
    fireworksL.frame = CGRectMake((KScreanWidth - 250) * 0.5, 100, 250, 50);
