...
- (UIButton*)closeButton{
    ...
    if(!_closeButton){
        ...
        //位置
        _closeButton.frame = CGRectMake(KScreanWidth - padding * 2, padding, padding, padding);

        [_closeButton setImage:[UIImage imageNamed:@"YXCapturePhotoCloseBtn"] forState:UIControlStateNormal];
...
- (UIButton*)cameraButton{
    if(!_cameraButton){
        _cameraButton = [UIButton new];
         ...
         //位置
        _cameraButton.frame = CGRectMake(KScreanWidth - padding * 4, padding, padding, padding);
        
        [_cameraButton setImage:[UIImage imageNamed:@"YXCapturePhotoSwitchCameraBtn"] forState:UIControlStateNormal];
...
- (UIButton*)beautyButton{
    if(!_beautyButton){
        ...
        [_beautyButton setImage:[UIImage imageNamed:@"YXFilter_None_white"] forState:UIControlStateSelected];
        [_beautyButton setImage:[UIImage imageNamed:@"YXFilter_MP_white"] forState:UIControlStateNormal];
...
- (UIButton*)startLiveButton{
    if(!_startLiveButton){
        ...
        //位置
        _startLiveButton.frame = CGRectMake((KScreanWidth - 200) * 0.5, KScreanHeight - 100, 200, 40);
